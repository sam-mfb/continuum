...
export const build68kArch = (initialState?: DeepPartial<AsmRegisters>): Asm68k => {
  ...
  const context: Asm68k = {
    ...
    get D4() { return registers.data.D4 },
    set D4(val: number) { registers.data.D4 = val },
    get D5() { return registers.data.D5 },
    set D5(val: number) { registers.data.D5 = val },
    get D6() { return registers.data.D6 },
    set D6(val: number) { registers.data.D6 = val },
    get D7() { return registers.data.D7 },
    set D7(val: number) { registers.data.D7 = val },
    ...
    get A2() { return registers.address.A2 },
    set A2(val: number) { registers.address.A2 = val },
    get A3() { return registers.address.A3 },
    set A3(val: number) { registers.address.A3 = val },
    get A4() { return registers.address.A4 },
    set A4(val: number) { registers.address.A4 = val },
    get A5() { return registers.address.A5 },
    set A5(val: number) { registers.address.A5 = val },
    get A6() { return registers.address.A6 },
    set A6(val: number) { registers.address.A6 = val },
    get A7() { return registers.address.A7 },
    set A7(val: number) { registers.address.A7 = val }
  }
