...
describe('createLine integration - produces all 8 line types', () => {
  ...
  it('demonstrates the 8 primary game directions', () => {
    ...
    const testCases = [
      ...
      { name: 'Game South (visual down)', x1: 100, y1: 100, x2: 100, y2: 125, expectedType: LINE_TYPE.E },
      { name: 'Game North (visual up)', x1: 100, y1: 100, x2: 100, y2: 75, expectedType: LINE_TYPE.E },
      { name: 'Game East (visual right)', x1: 100, y1: 100, x2: 125, y2: 100, expectedType: LINE_TYPE.N },
      { name: 'Game West (visual left)', x1: 100, y1: 100, x2: 75, y2: 100, expectedType: LINE_TYPE.N },
      { name: 'Game NE (visual up-right)', x1: 100, y1: 100, x2: 120, y2: 80, expectedType: LINE_TYPE.NE },
      { name: 'Game SE (visual down-right)', x1: 100, y1: 100, x2: 120, y2: 120, expectedType: LINE_TYPE.NE },
      { name: 'Game NW (visual up-left)', x1: 100, y1: 100, x2: 80, y2: 80, expectedType: LINE_TYPE.NE },
      { name: 'Game SW (visual down-left)', x1: 100, y1: 100, x2: 80, y2: 120, expectedType: LINE_TYPE.NE },
    ]
